...
public class Valid_Name {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chromedrive","chromedriver.exe");
		 ...
		 driver.findElement(By.id("ap_customer_name")).sendKeys("Christan maria");
		 driver.findElement(By.id("ap_email")).sendKeys("Christan.maria123@gmail.com");
		 driver.findElement(By.id("ap_password")).sendKeys("Christan123");
		 driver.findElement(By.id("ap_password_check")).sendKeys("Christan123");
		 Thread.sleep(2900);
